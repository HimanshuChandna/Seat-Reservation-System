...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6" action="./authentication/user_login.php" method="POST">
      <div>
    ...
    <p class="mt-10 text-center text-sm text-gray-500">
      ...
      <a href="user_signup.php" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Signup</a>
    </p>
  </div>
</div>
